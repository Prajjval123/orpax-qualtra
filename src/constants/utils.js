      ...
      value: [
        {
          ...
          description:
            "Want to deploy a cloud computing service, but not sure where to start? Let us help you. Once you have chosen us, your job is half done. We provide cloud solutions based on AWS, Azure, and Google Cloud Platform among others. We help you in setting up a proper cloud infrastructure with the right resources supported by top-notch customer support. We leverage the cloud platforms to open up opportunities for your business in the best possible way. Our solutions are centred around providing the best enterprise application experience to consumers. We take care of the complete process from the architecture of your cloud network and cloud solution to the deployment of your application. In addition to new cloud solutions, we have experience in migrating your existing applications to new platforms. Our engineers make sure that your cloud resources are cent percent utilized and are not wasted at any given point of time. We help you in rapidly adopting the cloud solutions to changes your business might go through. We also make sure that the health of your cloud infrastructure is perfect. We perform timely health checks in order to detect any sorts of discrepancies in the network or the infrastructure.",
        },
        {
  ...
  GIS_Services: [
    {
      ...
      value1: [
        ...
        },
        {
          ...
          description: "A land use depicts the human use of a specific land. Typically land uses represent the modifications and management of natural environments, built environments including pastures, fields, settlements and the wilderness. A land use map therefore depicts the activities, arrangements and inputs by people in a specific land cover type with the intention of producing, changing or maintaining the land. Our land use map preparation system contains a graphical representation of relevant policies and goals of our customers. Our land use maps illustrate an anticipated future development scenario and therefore could be used as a highly useful guide in the decision making process concerning any future land development. A land use map represents all the information pertaining to the uses of a specific land. These maps are prepared using a wide variety of applications. In a large number of countries typically land use map preparation is done by government agencies. However, there are many organizations and private sector individual groups who undertake the task of land use map preparations which are made available to the interested public searching for analysis options of the future trends. We, at ORPAX are willing to provide this service with the view of bridging the demand made by public interested in accessing filtered and non confidential information regarding a particular land or property. The zoning map is an example of a land use map. These maps are employed for the purpose of staking designated areas for identified land uses. The information is vital for developers as they can accordingly make their development plan to correspond with specific identified uses. The utilization map is also another land use map which is used in the process of zoning decisions and in determining if or not zoning changes are required in an identified land. The preparation of utilization maps is tedious and time consuming. That is why it is important for you to obtain these tremendously useful maps from a trusted and reliable service provider. The properly executed land use maps can highlight diverse activities including mining, farming, residential or industrial use, waste storage areas etc. Our land use maps are created with precise detail by a team of experts and our service range in land use mapping include, tax parcel mapping, utility mapping, road network mapping useful for street navigation methods, data preparation for computer based mass appraisal systems, contour digitization needed for terrain analysis, street centerline mapping, rail, airport, wetlands, highways mapping and land and soil use in agriculture and many other mapping needs. We cater to a broad range of sectors such as utilities, agriculture, transportations, oil and gas, forestry, land property tax authorities, Municipality planning authorities, environment and other Government and private based entities. Trust us with all your land use map preparation needs and see the difference we can make in enhancing overall productivity of your project.",
        },
        {
          ...
          points: [
            {
              title: "Our specialties in the Environmental Impact Assessment (EIA) Clearance section can be categorized as follows:",
              points: [
        ...
        },
        {
          ...
          points: [
            {
              title: "We provide specialized services on remote sensing and image processing ON,",
              points: [
          ...
          description: "Earth observation satellites are a good example of remote sensing and the tool has been used for a long time in a broad range of applications. With advancements made in sensor technology systems, it is now possible to conduct earth imaging tasks at an exceptional level of detail. With the advent of the new generation multi sensor system it has also invoked a new era for image processing thereby making room for the opportunity of integrating information and data from diverse sensor systems. Typically a remote sensing system would enable a consistent and repetitive view of the earth. This is most important to the process of observing the Earth system and consequences of human activities on earth. We are consistently leveraging our position as a leading service provider of remote sensing technologies and image processing tasks to integrate a wide range of geospatial expertise to our customers. From data capture systems, radar sensors to other advanced types of geospatial integration and image processing work such as Microsoft mapping and collaboration technologies we at ORPAX will have a solution. With our end-to-end systems, customized and innovative solutions which we continuously enhance with our considerable experience in the areas of remote sensing of data capture and optical and radar image processing we help change the way users acquire, visualize, analyze, distribute all types of geospatial information. At ORPAX we constantly update and develop operational strategies and uses of remote sensing data to enhance the cost advantages of satellite imagery and the practical application of these systems. Our in-house development systems support all our aims and this unique attitude of ours has largely underpinned our success story as well as contributed effectively to our customer organizations. We are ready to share our innovative technologies with you. Join us for a most effective solution.",
        },
      ],
      value2: [
        {
        ...
        },
        {
          ...
          description: "Finding out what GPS is about GPS which stands for global positioning systems is defined as a satellite based navigation methodology which consists of a 24 satellite network positioned in orbit. When the US Defense Department initiated this system their sole intention was to use it for various military applications. However, in 1980 the benefits of this system were made available for the civilians providing access to users from any part of the world on a 24 hour basis. GPS systems are compatible with all types of weather conditions and do not involve any set up or subscription charges. GPS - The essentials A GPS satellite has been programmed to circle earth twice within 24 hours and it moves in a precise orbit in order to transmit relevant signals to earth. The GPS receiving points based in various parts of the world absorbs the information and through a process of triangulation calculates the exact location of the user at any given time. A GPS receiver therefore, could compare the time when a particular signal has been transmitted by a satellite to the time in which it was received. This time difference will also indicate to the GPS receiver about the distance of the satellite. Similarly with more distance measurements from other satellites, a GPS receiver determines the user's location and transmits this information through a GPS unit's electronic map display. ORPAX offers Global Positioning System services with a complete asset management platform that we have developed for the exclusive use of entrepreneurs. As one of the leading service providers in this niche we provide our valuable customers with a fully integrated asset tracking system that is geared for easy management through a user friendly administration panel. Select our global positioning system services and enjoy a multitude of features in multi language support. Our solutions are perfect for those entrepreneurs looking to position their business in the next level. With state of the art tracking system we can provide a tailor made solution aimed to respond to all levels of customer's tracking needs while fitting in perfectly with their respective budgets. Use of global positioning systems for tracking One of the simplest techniques used in GPS is to enable a user who possesses a portable GPS unit to track their location at any given time and to help them in rectifying they are moving in the correct direction. GPS tracking devices can be used in combination with many other smart devices like phones or broadcast technologies such as the radio. The systems are highly useful for field work, defense sector as well as for personal household use, for instance in times when you need to keep track of a family member's whereabouts. GPS installation in vehicles is a very popular trend at present. It discounts the need for a car navigation system and useful for protecting vehicles from potential thefts. The system can be used for precision travelling, obtaining pass alerts etc. Global positioning systems possess diverse benefits in addition to the above, ranging from fleet coordination and tracking to many other consumer applications. With our customized solutions you will find endless options and a high quality asset management platform. Gain leverage of a comprehensive and all inclusive service with our quality backed global positioning systems.",
        },
        {
        ...
        },
        {
          ...
          description: "When you select ORPAX for your data integration and analysis needs you are also ensured of receiving a service that characterize the next generation in data integration and data analysis tools. Our services are epitomized by the following attributes: End to end data profiling We have a variety of standard data profiling tools, features and quality controls. Our metadata repository is stocked with project metadata and data analysis results like role level and project level security and administration. Competent content analysis Business focus approach The user interface we use is task based and therefore can be used by diverse business users for the reviewing and analyzing of data for changes over time and other anomalies. Our data integration and analysis tools take care of all the key functional and design requirements of developers. Flexible, scalable and adaptable architecture We have the capacity to manage high data quantities with analogue processing technology and use connectivity to retrieve an extensive range of targets and data sources. Our information analyzing tools can automate the function of source data analysis while expediting the process of comprehensive data profiling. This process also helps in reducing the overall costs as well as resources utilized for critical data integration tasks. In order to provide our customers with a consistence, coherent, timely and accurate service we undertake the following responsibilities associated with data integration and analysis. Data profiling and analysis This is an important task containing data examination to have a better understating of its dependency, redundancy and frequency and to authorize definitions and defined schema. Data monitoring Through this task we hope to uncover data quality problems within the source system procedure of data extraction and loading in to target systems. The authorization tools we provide will be useful for creating business metrics needs such as tracking over time. Facilitation of integration process This is executed with the aid of columns, tables, interrelationship and probable keys to aid the process of integration of design decisions. Data analysis is a useful tool for ascertaining the structure and content of data before a specific project implementation. The continuous use of this tool will yield valuable insights and help in the process of data integration. Data integration inclusive of data matching and cleansing is a prominent part of the data analysis process. Data migration and integration involves moving data from one source to another target system. The process of data profiling supports the entire system in three critical stages. Assessment of sources to define specific business requirement Development and operation of testing to authorize successful data integration in to target systems Design maps and reference tables from sources to target systems A large number of firms depend on out of date source documentation and incompetent technical support to conduct their data integration and analysis work with the end result being laborious work which too often create more chaos and confusion within the organization. ORPAX can play a pivotal role in helping you to establish a smoothly functioning effective and efficient data integration and analysis system. Contact us for a no obligation consultation today.",
        },
      ],
      value3: [
        {
          ...
          points: [
            {
              title: "See if you identify with any of the following scenarios that we have noticed as reasons for this stumbling block.",
              points: [
          ...
          description: "We have the in-house expertise to combine the worlds of satellite imagery, flat maps and 3D physical terrain models to give you an unmatched superior quality service. Our terrain modeling is created with spectacular rich color imaging that we use for the dimensional surface to make them appear stunning as much as they are rich in informative content. The technologies we use help us to provide our customers with accurate, affordable and fast results. Many contractors, particularly those who fall within the small to medium size category have encountered stumbling blocks when it comes to the production of digital terrain models. We build terrain models at affordable cost in timely manner. Our terrain modeling will allow your organization to take advantage of a GPS based layout and machine control while enjoying the associated benefit of cost effectiveness. The absence of a need to recruit specialized in-house personnel and invest in terrain modeling software will be a great relief on your company overheads. With our state of the art product solutions you are also given the opportunity of facing up to the competition with contractors even bigger than your own company. A terrain model replicates a fast overview of a specific landscape. Our team at ORPAX is capable of creating fascinating and beautiful works of models with their massive talents and extensive know-how. Their unique expertise lends a distinctive sense and touch to each portrayed landscape. Our solid terrain models are physical three dimensional models that users can view from any angle. They provide the opportunity for greater comprehension of the details presented where anyone can straight away absorb facts like distance, scale, sight lines, points of view, terrain etc. Our terrain modeling experts can create models of any shape, scale and size and in differing formats such as wall mounted, table tips or tiled.",
        },
        {
          ...
          description: "The term topography was given a whole new meaning with the advent of satellite based remote sensing and modern aerial photography which have the ability to derive continuous surface information via means of radar beams, laser beams or optical cameras. With the introduction of these new possibilities and techniques many users now have the ability to understand and analyze the biological, physical, cultural and chemical character of the earth's surface. In this regard the elevation data and information is represented in computerized digital format in what is known as the development of digital elevation models or DEMs. The DEM is therefore a computerized depiction of Earth's relief. DEM can be executed using various formats out of which the most typically used formats are the TIN or Triangulated Irregular Networks, contour lines, regular grids and scattered data points. Digital elevation models are represented by image matrixes or wire frames. These models are used in combination with many other spatial information and data and it is a vital tool used for database purposes, 3D animation such as fly throughs and topography related analyses. ORPAX provides expert services for development of digital elevation models for all kinds of users Our unique GIS and DEM services can be used separately or together. The development of digital elevation models, digital image processing and GIS technology has all become rapidly expanding sectors in the recent years. Particular significance has been witnessed in treatment of image and geo information in commercial, operational and scientific applications. A large number of applications in these fields find DEM to be an integral and important part. Our solutions have the capacity of enhancing analysis capabilities and invoking superior results and our models play an important role in the decision making and product development process of any organization. We foresee development of digital elevation models as useful asset needed in a variety of commercial and public sectors such as navigation, telecommunications, transportation, energy, weather forecast, disaster management, remote sensing, land cover classification, geodesy and civil engineering among many others. Our models are developed with the aim of assisting professional who rely on accurate and detail terrain knowledge. Therefore engineering firms involved in various infrastructure development projects can make use of our DEMs to complete their feasibility reports more easily, accurately and speedily with up to date depiction of geospatial information. We help in enhancing the decision making process, control operating costs and better evaluate the global investments. We cater for resource exploration needs, geological terrain analysis, field surveys, assessment of natural resources without 3D subsurface modelling techniques. Civil security agencies and organizations can make use of our models for mapping out flood hazard zones, estimate slopes and ascertain flow path directions. With our DEMs, users are given the opportunity of accessing a multi resolution capability. We are willing to edit our outputs according to client specifications to produce a high quality terrain representation. With us, you can be assured of utilizing the latest innovations and we ensure providing our valued customers with a state of the art service complete with management excellence. Our products and services are optimized for smartness, agility and perfect alignment with your end expectations.",
        },
        {
          ...
          points: [
            {
              title: "The digitization benefits you can enjoy with our raster and vector conversions are:",
              points: [
                "Total accuracy",
