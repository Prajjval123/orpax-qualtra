  ...
  GIS_Services: [
    {
      ...
      value1: [
        ...
        },
        {
          ...
          descriptionpoints: [{title: 'We provide specialized services on remote sensing and image processing TO,', points: [
      ...
      value2: [
        ...
        },
        {
          ...
          descriptionpoints: [{title: 'Topographical mapping.. How it is done', points: ["A large percentage of Raster to Vector conversions in topographical mapping is done using CAD based software like Microstation or Auto CAD. Specific features of a topographical map including boundary lines, contour lines, vegetation, water areas and forest areas etc are digitized or captured using different layers in order to create the Vector formatted topographic mapping. On the other hand, a 3D topographical map is made through a process of assigning 'Z' values to the respective contours to produce the topographical 3D terrain based model."]}, {title: 'Cadastral mapping .. How it is done', points: ["The production of cadastral mapping is a hard copy end product of the administrative maps. These maps have detail specifications of each plot of land, water bodies, railway lines, vegetations etc. The system is an effective tool to be used for management of various public land based records. Cadastral maps are also connected with a back end database that has all the details of the identified plot and its pertaining attributes. At ORPAX, we undertake all types of cadastral mapping projects including large scale mapping projects that necessitates scanning of various hard copy maps, geo referencing of each individual map, digitization of maps integrating proper layer structures, merging individual cadastral maps with single maps related to a particular area and many other related undertakings. The value of cadastral mapping is enhanced due to its associated benefits such as its ability to survey district names, issue certificates of title numbers, exclusive identification numbers for individual parcels, positions of existing sections, structures, lot numbers and respective areas, selection of boundary dimensions, references to earlier mapping and adjoining of contiguous street names etc."]}, {title: 'Orpax Qualtra is your one stop shop for requesting all types of topographical and cadastral mapping works. Our work expertise in land administration work encompasses a broad based range of verticals which include:', points: [
                "Topographical mapping",
                "Data overlays",
                "Cadastral parcel mapping",
                "Orthophoto imaging",
        ...
        },
        {
          ...
          descriptionpoints: [{title: 'Why choose ORPAX for you land information system?', points: ["- Our quality enterprising solutions", "Our land information systems contain rigorous and comprehensive methodologies relevant for the description of existing and intended structures of an organizatio's information systems and pertaining processes. Our intention is to pave the way for organizations to achieve their core goals with strategic directions. We have a policy of offering a service that goes beyond the simple provision of information technology as we endeavor to address ultimately successful business practices via the introduction of sound business architecture systems. Our systems are directly relevant to addressing productivity and performance.", "- Centralized information services", "With our centralized information services, our customers can produce and maintain land titles and cadastral data information within an inclusive and centralized spatial database environment. This facility will enhance system administration processes and efficiency in accessing data. As we have evolved an open architecture system, customers can link current databases along with third party information and applications relating to financial, land administration and assessment data within the same system.", "- Quality Assurance", "Our land information systems are complete with all inclusive sets of data productions, validation and maintenance tools. We have taken maximum steps to ensure provision of a quality data source with total integrity. Our quality assurance process has been further boosted with our ORPAX workflow management models which have the capacity of linking all business processes with the cadastral offices and registries.", "- Accurate transaction management", "Our applications are backed by transaction logs. The backup information also has the option of periodic review and evaluations so that the system can be evaluated for performance and possibility of improvement of performance. Also the connection of client transaction with diverse cost models allows the cadastral offices and registry to realize a nourishing business environment based on our quality services."]}, ],
          image:
            "/assets/For_Developing/services/testing/Land Information System.jpg",
          descriptionend: "ORPAX's land information systems are focused on providing public and private sector enterprises the ability to unlock their commercial value, captured within the hard copy data information as well as the current digital data. This provision would pave the way for better forecasting, planning and problem solving. With our end-to-end customized and innovative solutions which we continuously enhance with our considerable experience we guarantee in providing you with an industry leading Land Information System service.",
        },
        {
        ...
        },
        {
          ...
          descriptionpoints: [{title: 'Take a look at our unique database development services.\n Best quality database design options', points: ["The effective software designing plays a pivotal role in deriving a best quality custom database development task. The components that goes in to the process of software creation includes designing of database, interface, processing, testing, implementation, training plans, hardware procurement and finally the deployment plan. Each component has to be planned with meticulous care for success of the overall database development project. \n Our database designers can provide you with a conceptual database design and guide you with the proper data modeling tool selection to ensure indexing structures and relational database designs are in correct line. With our broad band knowledge and expertise we can help you to enhance overall operational performance of your organization and to augment customer loyalty and satisfaction. Don't wait for your competitors to make the first move. Get a leading edge on the competition by taking the initiative to implement a productive database development plan today."]}, {title: 'We use the latest software technologies..', points: ["Our database development services are provided using the latest software technologies for databases such as Access, Oracle, SQL Server 2000, DB2 and MySQL. We have a competent team of workers who can coordinate directly with your own staff to develop a fresh project from design stage to the training and implementation level."]}, {title: 'Data warehouse and database programming services', points: ["In today's dynamic business environment the task of database programming is continuously experiencing new evolvements and the procedure has developed dramatically from the simple task of hooking a program code with the database. We can be your beacon in providing successful and effective database development solutions. Our data warehouse designs are optimized for offloading reporting services from the active database transaction servers."]},],
          image:
            "/assets/For_Developing/services/testing/Data Base Development.jpg",
          descriptionend: "With the introduction of advanced broadband communication a large number of businesses and customers alike today demand real time access to information in databases in the most efficient manner. You can ensure you are one step ahead of this curve by updating all your programming techniques to state of the art database technologies as offered by us. Please take the initiative now and call us for a no obligation consultation and find out for yourself how we can help you solve all your database development, application and integration requirements.",
        },
        {
          ...
          descriptionpoints: [{title: 'End to end data profiling', points: ["We have a variety of standard data profiling tools, features and quality controls. Our metadata repository is stocked with project metadata and data analysis results like role level and project level security and administration."]},{title: 'Competent content analysis \n Business focus approach', points: ["The user interface we use is task based and therefore can be used by diverse business users for the reviewing and analyzing of data for changes over time and other anomalies. Our data integration and analysis tools take care of all the key functional and design requirements of developers."]},{title: 'Flexible, scalable and adaptable architecture', points: ["We have the capacity to manage high data quantities with analogue processing technology and use connectivity to retrieve an extensive range of targets and data sources. \n Our information analyzing tools can automate the function of source data analysis while expediting the process of comprehensive data profiling. This process also helps in reducing the overall costs as well as resources utilized for critical data integration tasks. In order to provide our customers with a consistence, coherent, timely and accurate service we undertake the following responsibilities associated with data integration and analysis."]},{title: 'Data profiling and analysis', points: ["This is an important task containing data examination to have a better understating of its dependency, redundancy and frequency and to authorize definitions and defined schema."]},{title: 'Data monitoring', points: ["Through this task we hope to uncover data quality problems within the source system procedure of data extraction and loading in to target systems. The authorization tools we provide will be useful for creating business metrics needs such as tracking over time."]},{title: 'Facilitation of integration process', points: ["This is executed with the aid of columns, tables, interrelationship and probable keys to aid the process of integration of design decisions. Data analysis is a useful tool for ascertaining the structure and content of data before a specific project implementation. The continuous use of this tool will yield valuable insights and help in the process of data integration. Data integration inclusive of data matching and cleansing is a prominent part of the data analysis process. Data migration and integration involves moving data from one source to another target system. The process of data profiling supports the entire system in three critical stages."]},{title: '', points: ["Assessment of sources to define specific business requirement", "Development and operation of testing to authorize successful data integration in to target systems", "Design maps and reference tables from sources to target systems"]},],
          image:
            "/assets/For_Developing/services/testing/Data Integration and Analysis.jpg",
          descriptionend: "A large number of firms depend on out of date source documentation and incompetent technical support to conduct their data integration and analysis work with the end result being laborious work which too often create more chaos and confusion within the organization. ORPAX can play a pivotal role in helping you to establish a smoothly functioning effective and efficient data integration and analysis system. Contact us for a no obligation consultation today.",
        },
      ],
      value3: [
        {
        ...
        },
        {
          ...
          ],}, {title: "When you select ORPAX for your raster and vector conversions you can:", points: []},{title: "", points: ["Create geodatabase lines, polygon features and shape files directly from a raster image", "Clean unwanted images within a particular raster image before proceeding with the batch vectorization", "Conduct interactive and batch mode data conversions", "With raster snapping options create interactive tracing for more efficient and accurate results"]},{title: "Our services can be highly beneficial for:", points: []},{title: "", points: ["Government agencies", "Municipal authorities with town planning map requirement", "Utilities", "Natural resource agencies"]},],
          image:
            "/assets/For_Developing/services/testing/Raster and Vector Data Conversion.jpg",
          descriptionend: "With us you can be assured of receiving a top notch mapping and digitalization of vector data derived from raster maps and our services are optimally focussed for successful scientific analyses and specific GIS applications.",
        },
        {
          ...
          descriptionpoints: [{title: 'ORPAX Web GIS applications', points: ['We provide the resources for map publication on the internet with spatial analysis and powerful visualization. With our innovative tools we guarantee that users across a wide expanse of organizations can reap the benefits from the shared web GIS applications we provide.']}, {title: 'When you select us as your web GIS provider you can enjoy the following advantages.', points: ['We provide true linear scalability to espouse a wide range of users', 'Our web based GIS applications could be custom tailored', 'The GIS applications can be accessed through your web browser', 'Reduced ownership costs via centrally managed web GIS applications']},{title: ' ', points: ['Our comprehensive GIS functionality and total solutions backed by outstanding performances, makes ORPAX the ideal service for people searching for internet based GIS applications. We have closely followed the trends to painstakingly develop a rich and high quality set of geoprocessing and visualization features. Our solutions can help your organization to make a new era in GIS by moving it to a new phase of accessibility to all members in your organization from the current isolation of one professional GIS workstation. With seamless access to web GIS applications and its unlimited opportunities, organizations with vast number of employees in call centers as well as other mobile based workers and the organization management, can retrieve important geographic data much faster and smarter helping them to streamline and strengthen their effective decision making process.']}, {title: 'ORPAX Desktop GIS applications', points: ['The ORPAX desktop GIS applications contain a rich set of geometry calculations and display option with a long range of unique advantages for the user. The specialized features and options we offer through our desktop GIS applications include smart labeling, dot density, charts, thematic shading and image support. We have developed a desktop GIS application system that can be used by any company around the world in their GIS mapping and visualization objectives.']},{title: 'We offer complete solutions for:', points: ['The creation of customized mapping and desktop GIS application needed to fulfill customer oriented specific tasks and requirements', 'Embedded mapping components vital for augmenting the quality of existing applications', 'Building of lightweight data view applications']}],
          image:
            "/assets/For_Developing/services/testing/Desktop and Web GIS Application.jpg",
          descriptionend: "Our desktop GIS applications are compatible in exploring the innovative world of open source GIS based software and we give a comprehensive guide to navigate and utilize the many features and options available.\n If you need to integrate your company with the next generation GIS technology, join hands with ORPAX. We can help you to discover your specific GIS user requirements and accordingly lay the foundation so that you can decide on the GIS solution that best fit your own organization.",
        },
      ],
    },
  ],
