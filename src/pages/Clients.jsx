...
const Clients = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center md:px-0 mt-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 w-full md:grid-cols-3 lg:grid-cols-4 px-8 lg:px-16 gap-8 mt-24 mb-12">
      ...
      <div className="grid md:grid-cols-1 w-full lg:grid-cols-3 px-8 lg:px-16 lg:flex-row gap-8">
