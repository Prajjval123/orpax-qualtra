...
const Projects = () => {
  return (
    <div className="p-4 lg:p-16 min-h-screen pb-0">
      <h1 className="text-5xl font-semibold mb-10 text-center p-4 animate-fade-in">
        Projects
      </h1>
        ...
        <div key={index} className="mb-24">
          ...
          <div className="flex flex-col mb-4">
            <div className="grid md:grid-cols-2 gap-12">
              <div className="bg-gray-900 w-full flex flex-col h-full gap-4 p-2 pb-4 rounded-xl border border-gray-600 shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
              <div className="p-4 rounded-xl">
                <img
                  src={projectArr[0].image}
                  alt="Project"
                  className="h-[300px] rounded-xl w-full"
                />
                </div>
                <div>
              ...
              <div
                key={index}
                className="bg-gray-900 w-full flex flex-col h-full gap-4 p-2 pb-4 rounded-xl border border-gray-600 shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer"
              >
                <div className="p-4 rounded-xl">
                <img
