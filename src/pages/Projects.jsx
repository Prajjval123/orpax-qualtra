...
const projects = [
  [
    {
      title:
        "High Speed Railway Corridor, Howrah-Haldia : Client – INECO SPAINHealth Monitoring System in the District of Agra - A GIS based Health Monitoring System : Client - FUTURE GROUP",
      points: [
  ...
  [
    {
      title:
        "Master Plan – Darjeeling : Client - RITES LTD.",
      points: [
        "Geo referencing of toposheets.",
        "Geo referencing of Satellite Imagery",
        "Mosaicing of satellite Imageries and Toposheets",
      ...
      image: "/assets/For_Developing/Projects_Section/project-3.jpg",
      description: ''
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-4.jpg",
    },
  ],
  [
    {
      title:
        "Land use and Land cover map preparation : Client – AHT Germany.",
      points: [
        "Geo referencing of toposheets.",
        "Geo referencing of Satellite Imagery",
        "Mosaicing of satellite Imageries and Toposheets",
      ...
      image: "/assets/For_Developing/Projects_Section/project-5.jpg",
      description: ''
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-6.jpg",
    },
  ],
  [
    {
      ...
      image: "/assets/For_Developing/Projects_Section/project-7.jpg",
      description: ''
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-8.jpg",
    },
  ],
  [
    {
      ...
      image: "/assets/For_Developing/Projects_Section/project-9.jpg",
      description: 'The custom application has been designed to provide mapping of population vulnerable to HIV/AIDS in the state of Orissa. The different target groups have been identified by specific symbols.'
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-10.jpg",
    },
  ],
  [
    {
      ...
      image: "/assets/For_Developing/Projects_Section/project-11.jpg",
      description: 'This was a prestigious job (a project of the Government of India) that (the software part) we undertook on behalf of AC Nielsen (the Indian wing of the transnational stalwart in market research); Reduction in vulnerability in old age for the 86% of workers located in the gigantic unorganized sector of India was the objective of the government. The sample size was no less than a whopping 40,000! Simply speaking, this software can be used to compare between two questionnaires and also compare the frequencies. It turned out to be, out-and-out, a huge success.'
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-12.jpg",
    },
  ],
  [
    {
      ...
      image: "/assets/For_Developing/Projects_Section/project-13.jpg",
      description: "Indian Incomes and Savings Survey (IISS) 2006 is Invest India's national syndicated survey of Indians with cash incomes. This will be repeated biannually to produce the first nationally representative and scalable time series of retail investor behavior in India. We designed and developed a tailor-made data analysis tool for this survey. This survey is the brainchild of Invest India Market Solution Pvt Ltd. ACNielsen conducted the survey per se. IISS 2006 has created a unique and integrated database that directly links the incomes, savings, insurance positions, credit portfolios and practices, investment outlook, labor market characteristics and demography of the Indian paid workforce. Our unique software, mentioned above, can not only generate simple user defined queries but dig deep within the data and generate graphs and reports that can be used for reports, presentations and further analysis."
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-14.jpg",
    },
  ],
  [
    {
      ...
      image: "/assets/For_Developing/Projects_Section/project-15.jpg",
      description: "The advantage of this system is the evolution of an ever growing system to collate and dispense painstakingly gathered and at the same time extremely useful health data to appropriate partners and agencies for the ultimate stakeholders, beneficiaries and the community at large."
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-16.jpg",
    },
  ],
  [
    {
      title:
        "Highway 3D Simulation : Client- Lea Associates, INDIA",
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-17.jpg",
      description: "3D animated perspective (3D Drive Through Vision) for 6 lining of the Gurgaon - Jaipur Section from km 42.700 to km 107.00 of NH8 in the state of Haryana on DBFO pattern under NHDP phase V."
    },
    {
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-18.jpg",
    },
  ],
  [
    {
      title:
        "Web Design and Development, Internet or Web Television",
      points: [
      ...
      image: "/assets/For_Developing/Projects_Section/project-19.jpg",
      description: "Web Tv is a web based television that provides consumers a 24 x 7 non-stop updation of the nation wide news as well as world wide news."
    },
    {
      points: [
        "A key goal of this effort is to provide latest news mainly concentrating on American and South Asian news. Through fosaac.Tv viewer can get news on politics, business, entertainment, sports, health, sci-tech, living etc. We also provide forums where viewrs can exchange their views and knowledge."
      ],
      image: "/assets/For_Developing/Projects_Section/project-20.jpg",
    },
    {
      points: [
    ...
    <div className="p-8 lg:p-24 min-h-screen pb-0 ">
      ...
      {projects.map((projectArr, index) => (
        <div key={index} className="mb-24">
          <h1 className="text-lg font-semibold px-4 py-2 rounded-xl text-gray-300 bg-red-700 text-center my-12">
            {projectArr[0].title}
          </h1>

          <div className="flex flex-col mb-4">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-900 w-full flex flex-col h-full gap-4 p-2 pb-4 text-white rounded-xl border border-white shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
                <img
